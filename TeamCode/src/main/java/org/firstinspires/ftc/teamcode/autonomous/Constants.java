...
public class Constants {
    // RED FRONT AUTONOMOUS CONSTANTS
    public static double RED_FRONT_SHOOTING_DEGREES = -128;
    ...
    public static double RED_BACK_SHOOTING_DEGREES = -111;
    public static double RED_BACK_SHOOTING_X = 10;
    public static double RED_BACK_SHOOTING_Y = -52;
    public static double RED_BACK_PICKUP_X1 = 16;
    public static double RED_BACK_PICKUP_X2 = 57;
    public static double RED_BACK_PICKUP_Y = -36;


    // BLUE BACK AUTONOMOUS CONSTANTS
    public static double BLUE_BACK_SHOOTING_DEGREES = -66;
    public static double BLUE_BACK_SHOOTING_X = -10;
    public static double BLUE_BACK_SHOOTING_Y = -52;
